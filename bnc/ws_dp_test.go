...
func TestDepthUpdateSingleWs(t *testing.T) {
	ws, err := StartNewDepthUpdateSingleWs(cex.SYMBOL_TYPE_UM_FUTURES, nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestDepthUpdateWs(t *testing.T) {
	ws := NewDepthUpdateWs(nil)
